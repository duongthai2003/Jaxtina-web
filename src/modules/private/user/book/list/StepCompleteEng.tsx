...
const StepCompleteEng = ({ bookId, code }: StepCompleteEngProps) => {
  ...
  const topicsToRender: Topic[] | any = Array.isArray(topicsData?.data)
    ? topicsData?.data
    : [topicsData?.data].filter(Boolean);
